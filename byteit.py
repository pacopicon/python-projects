...
def write_grayscale(filename, pixels):
    '''Creates and writes a grayscale BMP file.filename
    ...
    with open(filename, 'wb') as bmp:
        ...
        bmp.write(b'\x00\x00\x00\00') # litte-endian integer. Zero placeholder for now.
        ...
        bmp.write(b'\x00\x00\x00\00')      # to the pixel data. Zero placeholder for now.

        # Image Header
        bmp.write(b'\x28\x00\x00\00')       # Image header size in bytes - 40 decimal
        ...
        bmp.write(b'\x00\x00\x00\00')       # No compression
        bmp.write(b'\x00\x00\x00\00')       # Zero for uncompressed images 
        bmp.write(b'\x00\x00\x00\00')       # Unused pixels per meter
        bmp.write(b'\x00\x00\x00\00')       # Unused pixels per meter
        bmp.write(b'\x00\x00\x00\00')       # Use whole color table
        bmp.write(b'\x00\x00\x00\00')       # All colors are important
